...
// ****配置地图********
  ...
  useEffect(() => {
    ...
    // 根据点绘制线
    // const lineCoords = addressList.map(coord => fromLonLat(coord));
...
// ***********************
  ...
  <Button variant="light" size="sm" style={{marginRight:'10px'}} onClick={handlePrintPDF}>Print to PDF</Button>
      ...
      {/* 左主要菜单栏 */}
      <div className="left-sider" style={{ overflow: 'auto' }}>
        {/*支持鼠标滑滚 ，如果内容超出 */}
        <h5 style={{ paddingLeft: '20px', backgroundColor: '#666' }}>機能メニュー</h5>
